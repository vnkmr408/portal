    ...
    <body>
		...
		try
		{
			...
			Statement st = con.createStatement();    
                        ...
                        if (rs.next()) {
                        PreparedStatement ps = con.prepareStatement("insert into Order_Shipment(CATEGORY,TYPE,ITEM_NAME,PICKUP_LOCATION,DELIVERY_LOCATION,DATE,TIME,C_username,SIZE,WEIGHT,Status) values(?,?,?,?,?,?,?,?,?)");
                        ps.setString(6,date);
                        ps.setString(7,time);
