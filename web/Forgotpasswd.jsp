...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
	...
	<title>CSP || Forget Password</title>
	<style type="text/css">
	body{
    ...
    <header id="header" class="hoc clear"> 
      ...
      <!-- ################################################################################################ -->
        ...
        <div id="left">
            ...
            <form action="Forgotpasswd_process.jsp" method="post">
                <br>
                <h1 style="color:lightgrey; font-size: 25px">Forgot Password</h1><br>
                     
                    <label style="font-size: 20px; font-style:oblique; color:whitesmoke">You are a:</label>
			...
			<label for="male" style="font-size: 20px; font-style:oblique;color:whitesmoke  ">Mobile No.</label>
                        <input type="text" placeholder="Enter your Mobile no." name="mno"><br>
			<div id=".wrap">
                            <br>
